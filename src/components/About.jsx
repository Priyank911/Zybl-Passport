          ...
          <div className="about-grid-wrapper">
            <div className="about-grid">
              ...
              <div className="about-card animate-item">
                ...
                <p>
                  We combine biometric AI verification, behavioral pattern analysis, and on-chain wallet analysis to create a comprehensive Zybl resistance system with dynamic scoring.
                </p>
              </div>
